...
class oss {
    ...
    private static function initConfig() {
        ...
        self::$accessKeyId     = 'LTAIgUJrZmVhOlFB';
        self::$accessKeySecret = 'wAflUi7YiqrQ3HXEJlIymv4xI2R93C';
        self::$endpoint        = 'oss-cn-hangzhou.aliyuncs.com';
        self::$bucket          = 'aimai-goods-images';
    ...
    public function deleteObject($object = null) {
        ...
        for ($i = 0; $i < count($object); $i++) {
            preg_match("/goods\/img(.*)(jpg|jpeg|png)/U", $object[$i], $arr);
            $object2[$i] = $arr[0];
        }

        try {
            $ossClient->deleteObjects(self::$bucket, $object2);
        } catch (OssException $e) {
